...
switch($types)   // 根据请求的 Api，执行相应操作
{
    ...
    default:
        echo '<!doctype html><html><head><meta charset="utf-8"><title>API后台 - 疯子音乐</title><style>* {font-family: microsoft yahei; text-align: center;}</style></head><body><h1>疯子音乐内部API接口</h1><br/><h3>基于MKOnlinePlayer</h3><h4>源项目Github地址: https://github.com/mengkunsoft/MKOnlineMusicPlayer</h4><br/><br/>';
